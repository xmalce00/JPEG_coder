...
public class ColorTransformTest {
    ...
    void convertOriginalRGBtoYcBcRTest() {
        ...
        assertArrayEquals(testY, this.roundArray(matrixYcBcR[0]), "Složka Y je jiná než očekávaná. Ve třídě Jpeg.ColorTransform si zkontrolujte výpočet v metodě convertOriginalRGBtoYcBcRt()");
        assertArrayEquals(testCb, this.roundArray(matrixYcBcR[1]), "Složka Cb je jiná než očekávaná. Ve třídě Jpeg.ColorTransform si zkontrolujte výpočet v metodě convertOriginalRGBtoYcBcRt()");
        assertArrayEquals(testCr, this.roundArray(matrixYcBcR[2]), "Složka Cr je jiná než očekávaná. Ve třídě Jpeg.ColorTransform si zkontrolujte výpočet v metodě convertOriginalRGBtoYcBcRt()");

        System.out.println("Test převodu RGB na YCbCr proběhl v pořádku");
    }
    ...
    void convertModifiedYcBcRtoRGBTest() {
        ...
        assertArrayEquals(testRed, (int[][]) ModifiedYcBcRtoRGB[0], "Pravděpodobně se nachází chyba ve výpočtu. Ve třídě Jpeg.ColorTransform zkontrolujte metodu convertModifiedYcBcRtoRGB.");
        assertArrayEquals(testGreen, (int[][]) ModifiedYcBcRtoRGB[1], "Pravděpodobně se nachází chyba ve výpočtu. Ve třídě Jpeg.ColorTransform zkontrolujte metodu convertModifiedYcBcRtoRGB.");
        assertArrayEquals(testBlue, (int[][]) ModifiedYcBcRtoRGB[2], "Pravděpodobně se nachází chyba ve výpočtu. Ve třídě Jpeg.ColorTransform zkontrolujte metodu convertModifiedYcBcRtoRGB.");
        ...
        assertArrayEquals(testEdgeRed, (int[][]) ModifiedYcBcRtoRGBEdge[0], "Pravděpodobně nejsou ošetřeny hodnoty větší než 255. Ve třídě Jpeg.ColorTransform zkontrolujte metodu convertModifiedYcBcRtoRGB.");
        assertArrayEquals(testEdgeGreen, (int[][]) ModifiedYcBcRtoRGBEdge[1], "Pravděpodobně se nachází chyba ve výpočtu (hodnota může být mimo rozsah 0-255). Ve třídě Jpeg.ColorTransform zkontrolujte metodu convertModifiedYcBcRtoRGB.");
        assertArrayEquals(testEdgeBlue, (int[][]) ModifiedYcBcRtoRGBEdge[2], "Pravděpodobně nejsou ošetřeny hodnoty menší než 0. Ve třídě Jpeg.ColorTransform zkontrolujte metodu convertModifiedYcBcRtoRGB.");

        System.out.println("Test převodu YcBcR na RGB proběhl v pořádku");
    }
